...
//		controller.deleteBTprojectRecive("bt5");
		...
		System.out.println("=====donor_id로 헌혈자 삭제======");
//		controller.deleteDonorRecive("donor4");
//		controller.deleteDonorRecive("donor3");

		System.out.println("=====recipient_id로 수혈자 삭제=====");
//		controller.deleteRecipientRecive("Recipient4");
//		controller.deleteRecipientRecive("Recipient2");
